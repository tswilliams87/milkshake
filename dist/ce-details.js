...
customElements.define('tinderforbananas-details', /*#__PURE__*/function (_HTMLElement) {
  function _class() {
    var _this;
    _classCallCheck(this, _class);
    _this = _callSuper(this, _class);
    _this._carousel = _this.querySelector('tinderforbananas-carousel');
    return _this;
  }
  ...
  return _createClass(_class, [{
    ...
    value: function _updateBindings() {
      ...
      var _iterator = _createForOfIteratorHelper(this.data.images),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          div.style.backgroundImage = "url('".concat(imgSrc, "')");
      ...
      this.querySelector('.item__details__distance').textContent = "".concat(this.data.distance, " miles away");
