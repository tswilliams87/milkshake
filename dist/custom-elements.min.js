...
(function () {
  function c() {
    ...
    this.h = new Map();
    this.o = new Set();
    this.C = new MutationObserver(this.D.bind(this));
    this.f = null;
    this.F = new Set();
    this.enableFlush = !0;
    this.s = !1;
  ...
  function l(a) {
    if (!/^[a-z][.0-9_a-z]*-[\-.0-9_a-z]*$/.test(a) || -1 !== t.indexOf(a)) return Error("The element name '" + a + "' is not valid.");
  }
  function m(a, b, e, d) {
    var c = g();
    a = e ? n.call(a, b, e) : n.call(a, b);
    (b = c.a.get(b.toLowerCase())) && c.u(a, b, d);
    c.b(a);
    return a;
  }
  function p(a, b, e, d) {
    ...
    d.call(a, b, e);
    1 == a.__$CE_upgraded && (d = g().a.get(a.localName), e = d.A, (d = d.i) && 0 <= e.indexOf(b) && (e = a.getAttribute(b), e !== c && d.call(a, b, c, e, null)));
  }
  var f = document,
    h = window;
  if (g() && (g().g = function () {}, !g().forcePolyfill)) return;
  var t = "annotation-xml color-profile font-face font-face-src font-face-uri font-face-format font-face-name missing-glyph".split(" ");
  c.prototype.L = function (a, b) {
    ...
    var c = a,
      f = b.prototype;
    if ("object" !== _typeof(f)) throw new TypeError("Definition failed for '" + a + "': constructor.prototype must be an object");
    var d = e("connectedCallback"),
      g = e("disconnectedCallback"),
      k = e("attributeChangedCallback");
    this.a.set(c, {
      name: a,
      localName: c,
      constructor: b,
  ...
  c.prototype.b = function (a) {
    ...
    this.enableFlush && this.o.add(a.__$CE_observer);
  ...
  c.prototype.c = function (a, b) {
    ...
    for (var e = 0; e < a.length; e++) {
      ...
      if (d.nodeType === Node.ELEMENT_NODE) {
        ...
        do this.G(d.currentNode, b); while (d.nextNode());
      }
    }
  };
  c.prototype.G = function (a, b) {
    if (!b.has(a)) {
      b.add(a);
      var e = this.a.get(a.localName);
      if (e) {
        a.__$CE_upgraded || this.u(a, e, !0);
        var d;
        if (d = a.__$CE_upgraded && !a.__$CE_attached) a: {
          d = a;
          do {
      ...
      a.shadowRoot && this.c(a.shadowRoot.childNodes, b);
      "LINK" === a.tagName && a.rel && -1 !== a.rel.toLowerCase().split(" ").indexOf("import") && this.B(a, b);
    }
  };
  c.prototype.B = function (a, b) {
    var e = a["import"];
    if (e) b.has(e) || (b.add(e), e.__$CE_observer || this.b(e), this.c(e.childNodes, b));else if (b = a.href, !this.F.has(b)) {
      this.F.add(b);
      var d = this,
        _c = function c() {
          a.removeEventListener("load", _c);
          a["import"].__$CE_observer || d.b(a["import"]);
          d.c(a["import"].childNodes);
        };
      a.addEventListener("load", _c);
    }
  };
  c.prototype.H = function (a) {
    for (var b = 0; b < a.length; b++) {
      ...
      if (e.nodeType === Node.ELEMENT_NODE) {
        ...
        do {
          var d = e.currentNode;
          if (d.__$CE_upgraded && d.__$CE_attached) {
            d.__$CE_attached = !1;
            var c = this.a.get(d.localName);
            c && c.w && c.w.call(d);
          }
        } while (e.nextNode());
      }
  ...
  c.prototype.u = function (a, b, e) {
    ...
    e && (this.I(a), new b.constructor(), a.__$CE_upgraded = !0, console.assert(!this.f));
    e = b.A;
    if ((b = b.i) && 0 < e.length) {
      this.C.observe(a, {
        attributes: !0,
    ...
    for (var b = 0; b < a.length; b++) {
      ...
      if ("attributes" === c.type) {
        var d = c.target,
          ...
          h = c.oldValue,
          k = d.getAttribute(g);
        k !== h && f.i.call(d, g, h, k, c.attributeNamespace);
      }
    }
  };
  window.CustomElementRegistry = c;
  c.prototype.define = c.prototype.L;
  c.prototype.get = c.prototype.get;
  c.prototype.whenDefined = c.prototype.M;
  c.prototype.flush = c.prototype.g;
  c.prototype.polyfilled = !0;
  c.prototype._observeRoot = c.prototype.b;
  c.prototype._addImport = c.prototype.B;
  var q = h.HTMLElement;
  c.prototype.nativeHTMLElement = q;
  h.HTMLElement = function () {
    ...
    if (this.constructor) return a = a.j.get(this.constructor), m(f, a, void 0, !1);
    throw Error("Unknown constructor. Did you call customElements.define()?");
  };
  h.HTMLElement.prototype = q.prototype;
  ...
  r && Object.defineProperty(Element.prototype, "attachShadow", {
  ...
  f.importNode = function (a, b) {
    a = v.call(f, a, b);
    g().c(a.nodeType === Node.ELEMENT_NODE ? [a] : a.childNodes);
    return a;
  };
